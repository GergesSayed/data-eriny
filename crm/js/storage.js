...
const AppStorage = {
    ...
    isStrictB2BEntity(name, tags = {}) {
        ...
        // 3. Positive Corporate, Industrial, and Fleet Commercial Indicators
        const prefixRegex = /^(?:شركة|شركه|الشركة|الشركه|مصنع|المصنع|مجموعة|مجموعه|المجموعة|المجموعه|مؤسسة|مؤسسه|المؤسسة|المؤسسه|توكيل|التوكيل|صوامع|مطاحن|مستودع|مستودعات|محطة خرسانة|محطة خرسانه|محطة خلط|خلاطة|خلاطه|كسارة|كساره|مسبك|معامل تصنيع)\b/;
