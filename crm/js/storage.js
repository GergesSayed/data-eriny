...
const AppStorage = {
    ...
    isStrictB2BEntity(name, tags = {}) {
        ...
        // 0. Positive Fleet Transportation & Legitimate Car Rental Protection & Industrial Giants
        if (/(?:نقل جماعي|نقل العاملين|أساطيل الحافلات|اساطيل الحافلات|نقل الوفود والمؤتمرات|النقل بين المحافظات|نقل الركاب والرحلات|لتأجير السيارات|لتاجير السيارات|تأجير سيارات|تاجير سيارات|ليموزين|تأجير أساطيل|دكتور جريش|جريش|dr\.?\s*greiche|ابو اليزيد|ابواليزيد|أبو اليزيد)/i.test(n)) {
            return true;
        }
