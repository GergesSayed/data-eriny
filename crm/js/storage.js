...
const AppStorage = {
    ...
    cleanAndFixCompanyData(companies) {
        ...
        companies.forEach((c, idx) => {
            ...
            // 0b. Skip non-B2B entities (courts, schools, mosques, gov buildings, etc.)
            if (_nonB2BRegex.test(c.nameAr)) return;
    ...
    addCompanies(newCompanies) {
        ...
        // Non-B2B entity filter — block at the gate
        const _nonB2BRegex = /(مجمع محاكم|محكمة|محكمه|محاكم|النيابة العامة|نيابة|نيابه|مجلس الدولة|الشهر العقاري|مصلحة الضرائب|مصلحه الضرائب|مأمورية ضرائب|مامورية ضرائب|مبنى ادار|مبني ادار|مبنى إدار|مبني إدار|العهد الجديد|ديوان عام|ديوان المحافظ|الوحدة المحلية|الوحده المحليه|مجلس مدينة|مجلس مدينه|مجلس قروي|مكتب تموين|سجل مدني|سجل مدنى|مكتب بريد|سنترال|هيئة الأبنية|هيئه الابنيه|الشئون الاجتماعية|التضامن الاجتماعي|مدرسة|مدرسه|مدارس|حضانة|حضانه|روضة|روضه|جامعة|جامعه|كلية|كليه|معهد أزهري|معهد ازهري|سنتر تعليمي|مستشفى|مستشفي|مستشفا|عيادة|عياده|عيادات|مركز طبي|مركز طبى|صيدلية|صيدليه|صيدليات|مختبر تحاليل|معمل تحاليل|مسجد|جامع الن|جامع ال|مسجد ال|كنيسة|كنيسه|كاتدرائية|كاتدرائيه|دير الأنبا|دير الشهيد|دير القديس|دير السريان|دير المحرق|دير مار|دير وادي|مطرانية|مطرانيه|قسم شرطة|قسم شرطه|نقطة شرطة|نقطه شرطه|مركز شرطة|مركز شرطه|إدارة مرور|ادارة مرور|أمن مركزي|امن مركزي|معسكر|مركز شباب|نادي رياضي|نادى رياضى|نادي اجتماعي|نادى اجتماعى|حديقة عامة|حديقه عامه|ملعب خماسي|استاد|مقابر|مقبرة|مقبره|جبانة|جبانه|مدافن|مغسلة اموات|مغسله اموات|فرن بلدي|فرن بلدى|مخبز بلدي|مخبز بلدى|مطعم|كافيه|كافيتريا|كوفي شوب|بيتزا|كشري|فول وطعمية|سوبر ماركت|ميني ماركت|محل بقالة|محل بقاله|محل خضار|محل فاكه|محل جزارة|كوافير|صالون حلاقة|صالون حلاقه|بيوتي سنتر|سفارة|سفاره|قنصلية|قنصليه|ماكينة صراف|ماكينه صراف|ATM|فرع بنك|دار مناسبات|قاعة افراح|قاعه افراح|عربية كبدة|عربيه كبده|عربية فول|عربيه فول|كشك )/;
        ...
        newCompanies.forEach(c => {
            ...
            // Block non-B2B entities at the gate
            if (_nonB2BRegex.test(c.nameAr)) return;
    ...
    autoCleanAndMergeDuplicates() {
        ...
        // 1. Remove completely empty records and non-B2B entities (courts, schools, gov buildings, etc.)
        const _nonB2BRegex = /(مجمع محاكم|محكمة|محكمه|محاكم|النيابة العامة|نيابة|نيابه|مجلس الدولة|الشهر العقاري|مصلحة الضرائب|مصلحه الضرائب|مأمورية ضرائب|مامورية ضرائب|مبنى ادار|مبني ادار|مبنى إدار|مبني إدار|العهد الجديد|ديوان عام|ديوان المحافظ|الوحدة المحلية|الوحده المحليه|مجلس مدينة|مجلس مدينه|مجلس قروي|مكتب تموين|سجل مدني|سجل مدنى|مكتب بريد|سنترال|هيئة الأبنية|هيئه الابنيه|الشئون الاجتماعية|التضامن الاجتماعي|مدرسة|مدرسه|مدارس|حضانة|حضانه|روضة|روضه|جامعة|جامعه|كلية|كليه|معهد أزهري|معهد ازهري|سنتر تعليمي|مستشفى|مستشفي|مستشفا|عيادة|عياده|عيادات|مركز طبي|مركز طبى|صيدلية|صيدليه|صيدليات|مختبر تحاليل|معمل تحاليل|مسجد|جامع الن|جامع ال|مسجد ال|كنيسة|كنيسه|كاتدرائية|كاتدرائيه|دير الأنبا|دير الشهيد|دير القديس|دير السريان|دير المحرق|دير مار|دير وادي|مطرانية|مطرانيه|قسم شرطة|قسم شرطه|نقطة شرطة|نقطه شرطه|مركز شرطة|مركز شرطه|إدارة مرور|ادارة مرور|أمن مركزي|امن مركزي|معسكر|مركز شباب|نادي رياضي|نادى رياضى|نادي اجتماعي|نادى اجتماعى|حديقة عامة|حديقه عامه|ملعب خماسي|استاد|مقابر|مقبرة|مقبره|جبانة|جبانه|مدافن|مغسلة اموات|مغسله اموات|فرن بلدي|فرن بلدى|مخبز بلدي|مخبز بلدى|مطعم|كافيه|كافيتريا|كوفي شوب|بيتزا|كشري|فول وطعمية|سوبر ماركت|ميني ماركت|محل بقالة|محل بقاله|محل خضار|محل فاكه|محل جزارة|كوافير|صالون حلاقة|صالون حلاقه|بيوتي سنتر|سفارة|سفاره|قنصلية|قنصليه|ماكينة صراف|ماكينه صراف|ATM|فرع بنك|دار مناسبات|قاعة افراح|قاعة افراح|عربية كبدة|عربيه كبده|عربية فول|عربيه فول|كشك )/;
        const validCompanies = companies.filter(c => {
            const name = c.nameAr || c.name || c.nameEn || '';
            const hasName = name && name.trim().length > 0;
            if (!hasName || _nonB2BRegex.test(name)) {
                cleanedCount++;
                return false;
            }
            return true;
