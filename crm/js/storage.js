...
const AppStorage = {
    ...
    // ---- Strict B2B Entity Classifier & Validator ----
    isStrictB2BEntity(name) {
        ...
        // 1. Comprehensive Negative Blacklist (Roads, Ramps, Bridges, Transit, Geography, Government, Education, Health, Worship, Food Retail, Personal)
        const negRegex = /^(?:مطلع|منزل|نزلة|نزله|طلعة|طلعه|وصلة|وصله|محور|كوبري|كوبرى|طريق|شارع|دائري|دائرى|تقاطع|نفق|حارة|حاره|زقاق|ميدان|موقف|بوابة|بوابه|كارتة|كارته|كمين|مزلقان|عزبة|عزبه|كفر|نجع|قرية|قريه|حوض|ترعة|ترعه|مصرف|جزيرة|جزيره|جبل|تل|عمارة|عماره|مجاورة|مجاوره)\b|(?:^|\s)(?:مطلع|منزل|نزلة|نزله|طلعة|طلعه|وصلة|وصله|محور|كوبري|كوبرى|طريق|شارع|دائري|دائرى|تقاطع|نفق|موقف|كارتة|كارته|مزلقان|مجاورة|مجاوره)(?:\s|$)|(?:محطة مترو|محطة قطار|محطة اتوبيس|محطة ترام|محطة رسوم|موقف ميكروباص|موقف توشكى|محطة موبيل|محطة بنزين|محطة وقود|محطه ⛽|محطه بنزين|محطه وقود)|(?:مجمع محاكم|محكمة|محكمه|محاكم|النيابة العامة|نيابة|نيابه|مجلس الدولة|الشهر العقاري|مصلحة الضرائب|مصلحه الضرائب|مأمورية ضرائب|مامورية ضرائب|مصلحة الجمارك|مصلحه الجمارك)|(?:مبنى ادار|مبني ادار|مبنى إدار|مبني إدار|العهد الجديد|ديوان عام|ديوان المحافظ|الوحدة المحلية|الوحده المحليه|مجلس مدينة|مجلس مدينه|مجلس قروي|مكتب تموين|سجل مدني|سجل مدنى|مكتب بريد|سنترال|هيئة الأبنية|هيئه الابنيه|الشئون الاجتماعية|التضامن الاجتماعي|مكتب صحة|مكتب صحه|وحدة صحية|وحده صحيه|مباحث|إدارة مرور|ادارة مرور|مرور العاشر|مرور اكتوبر)|(?:مدرسة|مدرسه|مدارس|حضانة|حضانه|روضة|روضه|جامعة|جامعه|كلية|كليه|معهد أزهري|معهد ازهري|معهد موسيقي|معهد موسيقى|سنتر تعليمي|أكاديمية تعليمية|اكاديمية تعليمية|هندسة حلوان|هندسة عين شمس|هندسة القاهرة|طب القاهرة|طب عين شمس|كلية الهندسة|كلية الطب|كلية التجارة)|(?:مستشفى|مستشفي|مستشفا|عيادة|عياده|عيادات|مركز طبي|مركز طبى|مركز عيون|مركز أشعة|مركز اشعة|مركز علاج|مركز أسنان|مركز اسنان|للعيون|للأسنان|للاسنان|للأشعة|للاشعة|صيدلية|صيدليه|صيدليات|مستوصف|مختبر تحاليل|معمل تحاليل)|(?:مسجد|جامع الن|جامع ال|مسجد ال|كنيسة|كنيسه|كاتدرائية|كاتدرائيه|دير الأنبا|دير الشهيد|دير القديس|دير السريان|دير المحرق|دير مار|دير وادي|مطرانية|مطرانيه|خلوة|خلوه|بيت الخلوة|بيت الخلوه|بيت المؤتمرات|بيت الضيافة|بيت الضيافه|بيت الشباب|بيت القيثارة|بيت القيثاره|بيت ثقافة|بيت ثقافيه|جمعية خيرية|جمعيه خيريه|مؤسسة خيرية|مؤسسه خيريه|دار أيتام|دار ايتام|دار مسنين|دار رعاية|دار المناسبات|دار مناسبات|قاعة افراح|قاعه افراح)|(?:قسم شرطة|قسم شرطه|نقطة شرطة|نقطه شرطه|مركز شرطة|مركز شرطه|إدارة مرور|ادارة مرور|أمن مركزي|امن مركزي|معسكر|سجن|قاعدة جوية|قاعده جويه)|(?:مركز شباب|نادي رياضي|نادى رياضى|نادي اجتماعي|نادى اجتماعى|حديقة عامة|حديقه عامه|حدائق|ملعب|استاد|مقابر|مقبرة|مقبره|جبانة|جبانه|مدافن|مغسلة اموات|مغسله اموات)|(?:فرن بلدي|فرن بلدى|مخبز بلدي|مخبز بلدى|مخبز|حلواني|حلوانى|باتيسري|مطعم|كافيه|كافيتريا|كوفي شوب|بيتزا|كشري|فول وطعمية|مشويات|شاورما|كبابجي|اسماك|كبدة|سوبر ماركت|ميني ماركت|هايبر ماركت|محل بقالة|محل بقاله|محل خضار|محل فاكه|محل جزارة|محل دواجن|عطارة|عطاره|مقلة|مقله|محمصة|مول |shopping mall)|(?:كوافير|صالون حلاقة|صالون حلاقه|صالون رجالي|صالون حريمي|بيوتي سنتر|beauty salon|دراي كلين|dry clean|مغسلة ملابس|مغسله ملابس|خياط|ترزي|اتيليه|ميك اب|مكتبة عامة|مكتبه عامه|قرطاسية|ادوات مكتبية|ادوات كتابية|بلايستيشن|جيم |فتنس|سفارة|سفاره|قنصلية|قنصليه|ماكينة صراف|ماكينه صراف|ATM|صراف آلي|فرع بنك|خدمات فوري|أمان للمدفوعات|دار مناسبات|قاعة افراح|فوتوسيشن|ستوديو تصوير|استوديو تصوير|عربية كبدة|عربيه كبده|عربية فول|عربيه فول|كشك |بائع |محل موبايل|صيانة موبايل|صيانة شاشات)/;
        if (negRegex.test(n)) return false;

        // 2. Positive B2B Corporate / Industrial Keywords
        const posRegex = /^(?:شركة|شركه|الشركة|الشركه|مصنع|المصنع|مجموعة|مجموعه|المجموعة|المجموعه|مؤسسة|مؤسسه|المؤسسة|المؤسسه|توكيل|التوكيل|وكالة|وكاله|صوامع|مطاحن|مستودع|مستودعات|محطة خرسانة|محطة خرسانه|محطة خلط|خلاطة|خلاطه|كسارة|كساره|مسبك|معامل)\b|(?:للصناعات|للصناعة|للصناعه|للتجارة|للتجاره|للتوزيع|للنقل|للمقاولات|للاستثمار|للتوريدات|للبترول|للخدمات اللوجستية|للخدمات اللوجستيه|للتصدير|للاستيراد|للتنمية|للتنميه|القابضة|القابضه|المساهمة|المساهمه|ذ\.م\.م|ش\.م\.م|لإنتاج|لانتاج|لتصنيع|لتوزيع|لتدوير|لتجميع|للأدوية|للادوية|للأغذية|للاغذية|للنسيج|للغزل|للسيراميك|للحديد|للصلب|للأسمنت|للاسمنت|للكيماويات|للبلاستيك|للتعبئة|للتعبئه|للتغليف|للشحن)/;
        if (posRegex.test(n)) return true;
    ...
    autoCleanAndMergeDuplicates() {
        ...
        // 1. Remove completely empty records and non-B2B entities (roads, ramps, courts, schools, gov buildings, etc.)
