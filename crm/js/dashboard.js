...
const Dashboard = {
    ...
    updateStatCards(stats) {
        ...
        if (valEl) valEl.textContent = CRM.formatCurrency(stats.pipelineValue || 0);
            ...
            return `
                <div class="followup-item">
                    ...
                    <div class="followup-info">
                        ...
                        <div class="detail">${esc(call.contactPerson || '')} — ${CRM.getCallResultLabel(call.result)}</div>
                    </div>
    ...
    renderActivities() {
        ...
        const activities = CRM.getActivities(10);
