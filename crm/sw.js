/* ============================================
   ...
   v266.2 — Pre-cache App Shell for Offline Use
   ============================================ */

const CACHE_NAME = 'fleetcrm-v266-2-shell';
const OFFLINE_FALLBACK = './index.html';

// ── App Shell: Pre-cached on install for full offline support ──
const APP_SHELL = [
    './index.html',
    './css/style.css?v=266.2',
    './js/supabase-client.js?v=266.2',
    './js/egypt_verified_titans.js?v=266.2',
    './js/egypt_enterprises_pool.js?v=266.2',
    './js/companies-worker.js?v=266.2',
    './js/storage.js?v=266.2',
    './js/excel-handler.js?v=266.2',
    './js/dashboard.js?v=266.2',
    './js/companies.js?v=266.2',
    './js/calls.js?v=266.2',
    './js/reports.js?v=266.2',
    './js/scraper.js?v=266.2',
    './js/team.js?v=266.2',
    './js/settings.js?v=266.2',
    './js/app.js?v=266.2',
];
